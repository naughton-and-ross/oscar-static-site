<?php
	...
	$mysqli->query("INSERT INTO `inq` (name, schoolName, schoolPop, schoolLoc, phone, email, personType, state, actionReq) VALUES ('$name', '$schoolName', '$schoolPop', '$schoolLoc', '$phone', '$email', '$personType', '$state', '$actionReq')");	
?>
